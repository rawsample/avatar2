...
from avatar2.protocols.inception import InceptionPolling, InceptionProtocol, InceptionProtoCortexM3
...
class InceptionTarget(Target):
    ...
    def init(self):
        ...
        if self.processor == 'cortexM3':
            inception = InceptionProtoCortexM3(avatar=self.avatar, origin=self,
